...
function main() {
  ...
  //Horizontal
  for(var j = 0; j < 4; j++){
	  initVertexBuffers(gl,3,0,(j/2)+1,.5,.5,.5,255/255,0/255,0/255);
  } 
   
  //Vertical
  for(var j = 0; j < 4; j++){
	  initVertexBuffers(gl,(j/2)+1,0,.5,.5,.5,.5,255/255,0/255,0/255);
  } 
    for(var j = 0; j < 4; j++){
	  initVertexBuffers(gl,(j/2)+1,0,3,.5,.5,.5,255/255,0/255,0/255);
  } 
